...
<div class="template-cards">
  ...
  <a class="template-card" href="nf-core/differentialabundance/">
    <div class="template-card-logo">
  ...
  <a class="template-card" href="nf-core/funcscan/">
    <div class="template-card-logo">
  ...
  <a class="template-card" href="nf-core/rnafusion/">
    <div class="template-card-logo">
  ...
  <a class="template-card" href="nf-core/atacseq/">
    <div class="template-card-logo">
