<!-- Alias of differentialabundance-2.0.0.md — always tracks the newest template version. -->
...
|---|:--:|---|---|:--:|
| `samples` | <span class="gtd-badge gtd-direct">direct</span> | :material-table: Table | <span class="gtd-badge gtd-recipe">recipe</span> <code class="gtd-path">`nf-core/differentialabundance/samples.py`</code> | <span class="gtd-badge gtd-req">required</span> |
...
| `deseq2_results_annotated` | <span class="gtd-badge gtd-derived">derived</span> | :material-table: Table | <span class="gtd-badge gtd-recipe">recipe</span> <code class="gtd-path">`deseq2/results_annotated.py`</code> | <span class="gtd-badge gtd-opt">optional</span> |
| `deseq2_vst_pca` | <span class="gtd-badge gtd-direct">direct</span> | :material-table: Table | <span class="gtd-badge gtd-recipe">recipe</span> <code class="gtd-path">`deseq2/vst_pca.py`</code> | <span class="gtd-badge gtd-req">required</span> |
| `deseq2_vst_heatmap` | <span class="gtd-badge gtd-direct">direct</span> | :material-table: Table | <span class="gtd-badge gtd-recipe">recipe</span> <code class="gtd-path">`deseq2/vst_top_variable.py`</code> | <span class="gtd-badge gtd-req">required</span> |
| `deseq2_sample_distance` | <span class="gtd-badge gtd-direct">direct</span> | :material-table: Table | <span class="gtd-badge gtd-recipe">recipe</span> <code class="gtd-path">`deseq2/vst_sample_distance.py`</code> | <span class="gtd-badge gtd-req">required</span> |
