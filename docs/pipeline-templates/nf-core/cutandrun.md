...
- :material-chart-box-outline: **Sequencing and enrichment QC**: FastQC and Trim Galore, bowtie2 against the target genome and the spike-in, and the deepTools fingerprint that separates a target from its IgG control
...
=== ":material-tag-check-outline: 3.1 (latest)"
...
=== ":material-chart-box-outline:{ .mc-orange } Sequencing and enrichment QC"

    *Are the libraries clean, and does each target rise above its IgG control?*

    [![Sequencing and enrichment QC dashboard](../../images/pipeline-templates/nf-core/cutandrun/sequencing_and_enrichment_qc_light.png)](../../images/pipeline-templates/nf-core/cutandrun/sequencing_and_enrichment_qc_light.png){target="_blank" rel="noopener"}
...
=== ":material-chart-scatter-plot:{ .mc-indigo } Peak calls"
    ...
    *What each caller called on every sample, where the signal sits and how wide the calls are.*
    ...
    [![Peak calls dashboard](../../images/pipeline-templates/nf-core/cutandrun/peak_calls_light.png)](../../images/pipeline-templates/nf-core/cutandrun/peak_calls_light.png){target="_blank" rel="noopener"}
...
=== ":material-scale-balance:{ .mc-red } Caller agreement"
    ...
    *Two callers, one set of fragments: how much of each one's calls the other reproduced.*
    ...
    [![Caller agreement dashboard](../../images/pipeline-templates/nf-core/cutandrun/caller_agreement_light.png)](../../images/pipeline-templates/nf-core/cutandrun/caller_agreement_light.png){target="_blank" rel="noopener"}
...
=== ":material-set-merge:{ .mc-grape } Consensus and reproducibility"
    ...
    *The merged peak set of each target, and which replicates support every interval.*
    ...
    [![Consensus and reproducibility dashboard](../../images/pipeline-templates/nf-core/cutandrun/consensus_and_reproducibility_light.png)](../../images/pipeline-templates/nf-core/cutandrun/consensus_and_reproducibility_light.png){target="_blank" rel="noopener"}
