...
=== ":material-tag-check-outline: 4.0.0 (latest)"
...
=== ":material-bullseye-arrow:{ .mc-indigo } Screening overview"
    ...
    *What the four screens found, sample by sample.*
    ...
    [![Screening overview dashboard](../../images/pipeline-templates/nf-core/funcscan/screening_overview_light.png)](../../images/pipeline-templates/nf-core/funcscan/screening_overview_light.png){target="_blank" rel="noopener"}
...
=== ":material-bacteria-outline:{ .mc-red } Resistome"
    ...
    *Resistance genes across five ARG screens, harmonised into one vocabulary.*
    ...
    [![Resistome dashboard](../../images/pipeline-templates/nf-core/funcscan/resistome_light.png)](../../images/pipeline-templates/nf-core/funcscan/resistome_light.png){target="_blank" rel="noopener"}
...
=== ":material-atom:{ .mc-grape } AMPs"
    ...
    *Antimicrobial peptide candidates, their physicochemistry and their clusters.*
    ...
    [![AMPs dashboard](../../images/pipeline-templates/nf-core/funcscan/amps_light.png)](../../images/pipeline-templates/nf-core/funcscan/amps_light.png){target="_blank" rel="noopener"}
...
=== ":material-graph-outline:{ .mc-cyan } BGCs"
    ...
    *Biosynthetic gene clusters merged from antiSMASH, DeepBGC and GECCO.*
    ...
    [![BGCs dashboard](../../images/pipeline-templates/nf-core/funcscan/bgcs_light.png)](../../images/pipeline-templates/nf-core/funcscan/bgcs_light.png){target="_blank" rel="noopener"}
...
=== ":material-leaf:{ .mc-green } CAZymes"
    ...
    *Carbohydrate-active enzymes and the substrates their gene clusters target.*
    ...
    [![CAZymes dashboard](../../images/pipeline-templates/nf-core/funcscan/cazymes_light.png)](../../images/pipeline-templates/nf-core/funcscan/cazymes_light.png){target="_blank" rel="noopener"}
