...
- :material-chart-box-outline: **Sequencing QC**: FastQC and trimming, alignment and duplication, library complexity, and the enrichment panels that say whether a ChIP worked
...
=== ":material-tag-check-outline: 1.2.0 (latest)"
...
=== ":material-chart-box-outline:{ .mc-orange } Sequencing QC"

    *Are the libraries good, and is each ChIP enriched over its own input?*

    [![Sequencing QC dashboard](../../images/pipeline-templates/nf-core/chipseq/sequencing_qc_light.png)](../../images/pipeline-templates/nf-core/chipseq/sequencing_qc_light.png){target="_blank" rel="noopener"}
...
=== ":material-chart-scatter-plot:{ .mc-indigo } Peaks"
    ...
    *What MACS2 called in each sample, and where those calls sit.*
    ...
    [![Peaks dashboard](../../images/pipeline-templates/nf-core/chipseq/peaks_light.png)](../../images/pipeline-templates/nf-core/chipseq/peaks_light.png){target="_blank" rel="noopener"}
...
=== ":material-set-merge:{ .mc-cyan } Consensus"
    ...
    *Which intervals the replicates agree on, one peak set per antibody.*
    ...
    [![Consensus dashboard](../../images/pipeline-templates/nf-core/chipseq/consensus_light.png)](../../images/pipeline-templates/nf-core/chipseq/consensus_light.png){target="_blank" rel="noopener"}
...
=== ":material-scale-balance:{ .mc-grape } Differential binding"
    ...
    *Which consensus intervals change between conditions.*
    ...
    [![Differential binding dashboard](../../images/pipeline-templates/nf-core/chipseq/differential_binding_light.png)](../../images/pipeline-templates/nf-core/chipseq/differential_binding_light.png){target="_blank" rel="noopener"}
