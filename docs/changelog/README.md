...
* **Run provenance**: a template declares a `provenance:` block and the CLI collects the run's parameters, thresholds and tool versions into `template_origin`, shown as a searchable card in the ingestion report and in a dashboard modal. `--provenance-file` covers a pipeline with no template. See [Run provenance](../usage/projects/templates.md#run-provenance) ([#1002](https://github.com/depictio/depictio/pull/1002), [4ef63950](https://github.com/depictio/depictio/commit/4ef63950), [3fe35f5c](https://github.com/depictio/depictio/commit/3fe35f5c)).
* **The canvas leads with a real tab header**: the tab's name, its description and its icon, all fields a tab already carried and never showed. See [Dashboard Tabs](../features/dashboards.md#dashboard-tabs) ([#1002](https://github.com/depictio/depictio/pull/1002), [4a5cf5e0](https://github.com/depictio/depictio/commit/4a5cf5e0)).
* **Rarefaction curves are pre-aggregated at ingest** into `alpha_rarefaction_summary`, so "Group by" offers every categorical column the collection carries. See [ampliseq](../pipeline-templates/nf-core/ampliseq.md) ([#1002](https://github.com/depictio/depictio/pull/1002), [740fa643](https://github.com/depictio/depictio/commit/740fa643)).

### **🚀 Improvements**

* **Layout and panel state**: grid packing and widening run per section, so one section's cards no longer collide with another's; the 8-column layout holds down to 880px of content width; and the filter panel remembers its collapse, width and folds per tab family, a folded section showing its cards as summary chips. See [Using the dashboard](../usage/guides/dashboard_usage.md#working-with-the-filter-panel-v140) ([#1002](https://github.com/depictio/depictio/pull/1002), [ff6e4f7b](https://github.com/depictio/depictio/commit/ff6e4f7b), [0712a5a8](https://github.com/depictio/depictio/commit/0712a5a8)).

### **🐛 Bug Fixes**

* **Filters that silently did nothing now apply**: UpSet plots and the hierarchical heatmap match by value rather than by a hardcoded column name, `tag:` link placeholders resolve at read time so cross-DC filtering works on an imported project, and a section rendered family-wide no longer reads as "no constraint" on the other tabs. See [Cross-DC Filtering](../features/cross-dc-filtering.md#link-fields) ([#1002](https://github.com/depictio/depictio/pull/1002), [c99a6702](https://github.com/depictio/depictio/commit/c99a6702), [b4dbf1ef](https://github.com/depictio/depictio/commit/b4dbf1ef), [a4620325](https://github.com/depictio/depictio/commit/a4620325)).
...
* **Layout and rendering**: the viewer honours `tab_order`, server-rendered figures share the client's colours, `box_plot_stats` renders as a box plot under any secondary layout, and a foreign `pin: top` section sits below the host tab's own header ([#1002](https://github.com/depictio/depictio/pull/1002), [d178da2d](https://github.com/depictio/depictio/commit/d178da2d), [054a1352](https://github.com/depictio/depictio/commit/054a1352), [08e92eb0](https://github.com/depictio/depictio/commit/08e92eb0)).
