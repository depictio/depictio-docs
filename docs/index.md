...
<span class="fc-arg">    dashboard.yaml</span></div>
    ...
    <article class="feature-row">
      <div class="feature-row-visual">
        <button type="button" class="feature-frame" aria-label="Enlarge the screenshot: the admin Backups tab">
          <img class="only-light" src="images/landing/operate_light.webp" alt="The admin Backups tab: the snapshots on the server, and the schedule and retention policy that produced them" loading="lazy">
