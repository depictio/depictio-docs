...
<div style="border: 1px solid grey; width: 602px; padding: 1px;">
    <a href="../../../images/guides/dashboard_creation/step_three_figure_scatter.png" target="_blank">
        <img src="../../../images/guides/dashboard_creation/step_three_figure_scatter.png" width="600">
    </a>
</div>
...
<div style="border: 1px solid grey; width: 602px; padding: 1px;">
    <a href="../../../images/guides/dashboard_creation/step_three_figure_histogram.png" target="_blank">
        <img src="../../../images/guides/dashboard_creation/step_three_figure_histogram.png" width="600">
    </a>
</div>

<div style="border: 1px solid grey; width: 602px; padding: 1px;">
    <a href="../../../images/guides/dashboard_creation/step_three_interactive.png" target="_blank">
