...
5. Click the **Register** button to submit your registration details.
   
6. After successful registration, you can return to the login page by clicking the **Back to Login** button.
...
!!! note
    ...
    <div style="border: 0px solid grey; width: 602px; padding: 1px;">
...
- At the bottom of the left sidebar, you will find:
  ...
  - **User information**: Displays your username and email (e.g., "test3@embl.de").
