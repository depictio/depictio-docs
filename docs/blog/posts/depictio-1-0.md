...
![Joining merges tables once at ingestion; linking merges nothing and filters at render time, across any data type](../../images/data-model/join-vs-link_light.png)
